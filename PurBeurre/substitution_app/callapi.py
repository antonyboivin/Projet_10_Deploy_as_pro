...
####################################### substistution
def request_for_substitution_products_in_openfoodfact_api(categorie_query, categorie_query2):
    ...
    try:
        ...
        return "Message d'erreur 404, pas de chance !"
